		...
		<textarea class="selected_highlight_template template"><!-- 			
			<div class="record">
				<div class="fright" style="text-align: center">
					{#if $T.user.photo_id}
						<img class="user_photo" style="width: 70px; height: 70px; border-radius: 6px; object-fit: cover;" src="DigitalMediaController/?id={$T.user.photo_id}"/>
					{#else}
						<img class="user_photo" style="width: 70px; height: 70px; border-radius: 6px;" src="static/images/photo.png"/>
					{#/if}
				</div>
